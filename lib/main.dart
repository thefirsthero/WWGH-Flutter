...
import 'package:guest_house_app/routes/routes.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        home: Consumer<AuthProvider>(builder: (context, appState, child) {
            if(appState.loginState == ApplicationLoginState.loggedIn){
              Provider.of<UserProvider>(context,listen: false).isUserExists();
              return HomeScreen();
            }else {
              return SignUpScreen();
            }
        ...
        //         //TODO remove the user completly
        //         return LoginScreen();
