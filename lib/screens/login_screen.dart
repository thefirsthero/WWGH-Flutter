          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButtons().buildSubmitButton(context,doLogin,"Login to your Account"),
               
                const SizedBox(
                  height: 10,
                ),
                TextButtons().buildButton(context, "/forgotPassword", "ForgotPassword"),
                const SizedBox(
                  height: 10,
                ),
                ...
                TextButtons().buildButton(context, "/signup", "Create Your Account"),
              ],
            ),
          ),
        ),
