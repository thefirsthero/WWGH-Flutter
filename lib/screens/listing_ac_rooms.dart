...
class ListingACRoomsScreen extends StatelessWidget {
  const ListingACRoomsScreen({Key? key}) : super(key: key);
              ...
              child: SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    listingCardContainer(context, "AC Sharing Rooom","AC Room"),
                    listingCardContainer(context, "AC Single Rooom","AC Room"),
                  ],
                ),
              ),
            )
